...
# Callback
checkpoint_path=parent_dir+'/weights/pneu/{epoch:03d}.ckpt'
...
datagen=tf.keras.preprocessing.image.ImageDataGenerator(rotation_range=4, height_shift_range=0.04, width_shift_range=0.04,
                                                       horizontal_flip=True, shear_range=0.1, brightness_range=[0.9, 1.])

alpha=0.2

# ============== train ==============

weight_path=parent_dir+'/weights/pneu/0.h5'
...
weight_path=parent_dir+'/weights/pneu/'
save_path=parent_dir+'/result_csv_files/pneu.csv'

create_csv_file(model, normal_image_path, weight_nbr, weight_path, save_path)
